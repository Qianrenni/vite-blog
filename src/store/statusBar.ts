  ...
  actions: {
    setStatusBarHeight(height: number) {
      ...
      if (root && window) {
        ...
        rootElement.style.setProperty(
          ...
          `${windowHeight - this.statusBarHeight - 30}px`,
        );
        rootElement.style.setProperty(
          "--content-height-2",
          `${windowHeight - this.statusBarHeight - 85}px`,
        );
    ...
    resetContentHeight() {
      ...
      if (root && window) {
        ...
        console.log(
          "resize",
          rootElement.style.getPropertyValue("--content-height-without-header"),
        );
        console.log(
          "resize",
          rootElement.style.getPropertyValue("--content-height-2"),
        );
      }
    },
  },
